...
<div class="category-header-container">
    <img src="http://localhost:8888/wordpress-asp/wp-content/uploads/2017/02/IMG_9592-copy.jpg">
    <div class="category-header-title-container">
        <h1>Music</h1>
        <h6>Visit a world through the sound.</h6>
    </div>
</div>
...
<div class="row category-main-container">
  ...
  <script>
    jQuery(function($) {
      var activeSphere = $('#menu-item-113');
